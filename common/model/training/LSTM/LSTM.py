...
def const_interpol(for_ffmpeg = False):
    '''
    ...
    '''
    if for_ffmpeg:
        # For ffmpeg. This is a string as it is supplied in a list to subprocess.
        return "neighbor"
    else:
        # for OpenCV
...
def preprocess_input(frame, audio,
    ...
    n = int(frame.shape[0]/2) # this should ALWAYS be an integer
    F1 = frame[:n,:,:] # first n images
    F2 = frame[n:,:,:] # last n images
